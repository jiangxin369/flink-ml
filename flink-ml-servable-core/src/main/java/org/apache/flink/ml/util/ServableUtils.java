...
public class ServableUtils {
     ...
     * match the className of the previousPipelineModelServable.javaly saved PipelineModel.
     *
    ...
    /**
     * Loads the servable from the given path by invoking the static loadServable() method of the
     * stage. The stage class name is read from the metadata file under the given path. The
     * loadServable() method is expected to construct the servable instance with the saved
     * parameters, model data and other metadata if exists.
     *
    ...
    /**
     * Loads the servable with the saved parameters from the given path. This method reads the
     * metadata file under the given path, instantiates the servable using its no-argument
     * constructor, and loads the servable with the paramMap from the metadata file.
     *
