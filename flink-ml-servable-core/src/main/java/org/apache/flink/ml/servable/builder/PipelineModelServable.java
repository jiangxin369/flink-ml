...
/**
 * A PipelineModelServable acts as a ModelServable. It consists of an ordered list of servables,
 * each of which could be a TransformerServable or ModelServable.
 */
@PublicEvolving
public final class PipelineModelServable implements ModelServable<PipelineModelServable> {
    ...
    public static PipelineModelServable load(String path) throws IOException {
        return new PipelineModelServable(ServableUtils.loadPipeline(path));
    }
