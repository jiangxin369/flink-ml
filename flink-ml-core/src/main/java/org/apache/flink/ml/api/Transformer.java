 ...
 * static method with signature {@code static T loadServable(String path)}, where {@code T} refers
 * to the concrete subclass of {@link TransformerServable}. This static method should instantiate a
